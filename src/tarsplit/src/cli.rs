...
impl<'a, 'b> Cli<'a, 'b> {
    fn initialize_parser() -> clap::App<'a, 'b> {
        ...
        clap::App::new("tarsplit")
            ...
            .arg(clap::Arg::with_name("SOURCE").takes_value(true).required(true).help("Path to source TAR archive"))
            .arg(
